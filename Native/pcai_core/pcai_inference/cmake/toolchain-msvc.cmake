...
# Compiler launchers (sccache/ccache)
if(DEFINED ENV{CMAKE_C_COMPILER_LAUNCHER})
    set(CMAKE_C_COMPILER_LAUNCHER "$ENV{CMAKE_C_COMPILER_LAUNCHER}" CACHE STRING "C compiler launcher" FORCE)
endif()
if(DEFINED ENV{CMAKE_CXX_COMPILER_LAUNCHER})
    set(CMAKE_CXX_COMPILER_LAUNCHER "$ENV{CMAKE_CXX_COMPILER_LAUNCHER}" CACHE STRING "C++ compiler launcher" FORCE)
endif()
if(DEFINED ENV{CMAKE_CUDA_COMPILER_LAUNCHER})
    set(CMAKE_CUDA_COMPILER_LAUNCHER "$ENV{CMAKE_CUDA_COMPILER_LAUNCHER}" CACHE STRING "CUDA compiler launcher" FORCE)
endif()

# Optional lld-link integration
if(DEFINED ENV{CMAKE_LINKER} AND EXISTS "$ENV{CMAKE_LINKER}")
    set(CMAKE_LINKER "$ENV{CMAKE_LINKER}" CACHE FILEPATH "Linker" FORCE)
endif()
